...
url = 'https://news.naver.com/main/clusterArticles.naver?id=c_202204291050_00000280&mode=LSD&mid=shm&sid1=105&oid=011&aid=0004048517'
...
result = soup.find_all('a', {'class', 'nclicks(cls_sci.clsart1)'})      # 전부 찾기/ 그냥 find는 발견된 첫번째 하나만 찾아줌

titles = []

for r in result:
    if len(r.text) > 8:                                    #길이가 8 초과인 문자열만 필터링
