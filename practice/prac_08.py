...
print(categorical_y)                                                        # 정답의 결과 수를 num_classes와 맞추어줘야함 (word_count로 맞춤)
...
model.fit(pad_sequences, categorical_y, epochs=100)                     #실제 학습 / 경사 하강 횟수 (=epoch)- x에 해당되는 전체 데이터를 모두 학습
